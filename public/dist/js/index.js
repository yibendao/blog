layui.config({
	...
	//图片总数
	$.get("http://www.zjsoar.com/layuicms/json/images.json",
		function(data){
	...
	//用户数
	$.get("http://www.zjsoar.com/layuicms/json/usersList.json",
		function(data){
	...
	//新消息
	$.get("http://www.zjsoar.com/layuicms/json/message.json",
		function(data){
	...
	if(window.sessionStorage.getItem("systemParameter")){
		...
		$.ajax({
			url : "http://www.zjsoar.com/layuicms/json/systemParameter.json",
			type : "get",
			dataType : "json",
